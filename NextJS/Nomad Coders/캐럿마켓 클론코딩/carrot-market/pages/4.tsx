...
const TourOfTailwind: NextPage = () => {
  return (
    <div className="bg-slate-400 dark xl:place-content-center py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      {/* <div className="bg-white sm:hover:bg-pink-800 sm:bg-red-400 md:bg-teal-400 lg:bg-indigo-400 xl:bg-yellow-400 2xl:bg-pink-400 p-6 rounded-3xl shadow-xl"> */}
      <div className="bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <button className="mt-5 bg-blue-500 dark:bg-black dark:border-white dark:border text-white p-3 text-center rounded-xl w-2/4 mx-auto dark:hover:bg-white hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500">
          Checkout
        </button>
      </div>
      ...
      <div className="bg-white p-6 rounded-3xl shadow-xl lg:col-span-2 xl:col-span-1">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between items-center">
            <span className="font-medium text-2xl">$350</span>
    ...
    //     className="required:border-2 border-yellow-500 invalid:bg-red-500 valid:bg-teal-500 placeholder:text-teal-500 placeholder-shown:bg-teal-500 disabled:opacity-0"
    //   />
    ...
    //     required
    //     placeholder="Username"
    //     className="border p-1 peer border-gray-500 rounded-md"
    //   />
    ...
    //   <h2 className="text-[851px] text-[#000]">Hello</h2>
    // </div>
  );
};

export default TourOfTailwind;
